...
class Server:
    ...
    def verify_ldap_cert(username):
        ...
        path = conn.search_s('dc=ldap,dc=projet,dc=com', ldap.SCOPE_SUBTREE,
        ...
        try:
            ...
            cert = ''
        path = "./chat-room/my_app/client/clients_crt/crt" + username + ".pem"
